...
import me.nytyr.deployd.android.requester.http.DeleteRequester;
...
public class DeleteRequesterTest {
    @Test
    public void givenValidData_WhenRun_ShouldReturnValidBody() throws HttpRequesterException, JSONException {
        HashMap<String, String> headers = new HashMap<String, String>();
        headers.put("header", "value");
        Response response = new DeleteRequester(20000).run(
                new Request("http://httpbin.org/delete?foo=bar", "", headers)
        );
        ...
        expected.put("url", "http://httpbin.org/delete?foo=bar");
